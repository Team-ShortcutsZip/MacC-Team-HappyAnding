...
extension View {
    ...
    func getDestination<T: Hashable>(data: T) -> some View {
        ...
        case is NavigationReadCurationType:
            ReadCurationView(readCurationViewModel: ReadCurationViewModel(data: data as! NavigationReadCurationType))
    ...
    func body(content: Content) -> some View {
        content
            ...
            .navigationDestination(for: NavigationReadCurationType.self) { data in
                ReadCurationView(readCurationViewModel: ReadCurationViewModel(data: data))
            }
